...
echo '</td>';
echo '<td>';
echo '<form action="viewProfile.php">';
...
echo  '<input type="Submit" class="btn btn-success" value="Update Details" > ';
echo  '</form>';
echo '</td>';
echo '<td>';
echo '<form action="donor.php">';
echo  '<input type="Submit" class="btn btn-success" value="Delete Record" > ';
echo  '</form>';
echo '</td>';
echo '</tr>';
}
