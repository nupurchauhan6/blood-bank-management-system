...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <form name="myform" method="post" action="../donor/saveDonor.php" onsubmit="return(validate());"
            ...
            <div class="col-4">
                <form method="post" action="../donor/searchResult.php">
                    ...
                    Select City:
                    <select id="city" name="city" class="form-control" style="margin-top: 15px;margin-bottom: 15px;">
                        <option value="">-Select City-</option>
                    </select>
                    <input type="Submit" class="btn btn-success">
                </form>
