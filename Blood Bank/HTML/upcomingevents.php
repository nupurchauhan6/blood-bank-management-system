...
<table align="center">
<tr>
<th colspan="5">UPCOMING BLOOD DONATION CAMPS</th>
</tr>
<tr>
<th>LOCATION</th>
<th> DATE</th>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '</td>';
        echo '<td>';
        echo '<input type="Submit" class="btn btn-success" value="Delete" style="margin: 10px;">';
        echo '</td>';
         echo '<td>';
        echo '<input type="Submit" class="btn btn-success" value="Update" style="margin: 10px;">';
        echo '</td>';
        echo '</tr>';
