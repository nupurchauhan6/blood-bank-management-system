...
$password=$_SESSION["password"];
 ...
 $sql = "UPDATE donor SET fullname='$fullname' ,mobileno='$mobileno',residentno='$residentno',weight='$weight',address='$address',gender='$gender',date='$date',ldate='ldate',bloodgroup='$bloodgroup',state='$state',city='$city' WHERE email='$email'";
